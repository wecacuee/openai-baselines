#PBS -N fwrl-her-train-path-rewards-low-thresh-chosen  # Any name to identify your job
...
from baselines.her.experiment.train_many import (exp_conf_path_reward_low_thresh_chosen,
                                                 run_one_experiment)
exp_conf, common_kwargs = exp_conf_path_reward_low_thresh_chosen(num_cpu = 6, gitrev = "be467df")
...
# >>> print("\n".join(map(str, enumerate(exp_conf_path_reward_low_thresh_chosen()[0].items()))))
