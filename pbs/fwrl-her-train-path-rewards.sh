...
#PBS -l nodes=retinene:ppn=6:gpus=1 # nodes requested: Processor per node: gpus requested
...
. setup.sh
python <<EOF
from baselines.her.experiment.train_many import train_her_fwrl_path_reward
train_her_fwrl_path_reward(num_cpu = 6)
EOF
